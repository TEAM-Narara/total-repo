...
class GetLocalScreenListsInCardsFilterUseCase @Inject constructor(
    ...
    suspend operator fun invoke(boardId: Long, searchParameters: SearchParameters) = listRepository.getLocalScreenListsInCardsFilter(
        boardId = boardId,
        includeNoRepresentative = searchParameters.noMember.int,
        ...
        includeNoLabel = searchParameters.noLabel.int,
