...
public interface WorkSpaceMemberRepository extends JpaRepository<WorkSpaceMember, Long> {
    @Query("SELECT wsm from WorkSpaceMember wsm left join wsm.workSpace ws left join wsm.member where ws.id = :workspaceId and ws.isDeleted = false and wsm.isDeleted = false")
    ...
    boolean existsByWorkSpaceAndIsDeletedIsFalse(WorkSpace workspace);
